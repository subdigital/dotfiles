return {
  ...
  config = function()
    ...
    keymap.set("n", "<leader>hf", "<cmd>Telescope harpoon marks<cr>", { desc = "Search harpoon marks" })
    ...
    keymap.set("n", "<leader>4", "<cmd>lua require('harpoon.ui').nav_file(4)<cr>", { desc = "Navigate to harpoon 4" })
  end
}
